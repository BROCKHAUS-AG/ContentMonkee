...
namespace BAG.Geolocation.Provider.MaxMind
{
    using System.Configuration;

    using BAG.Geolocation.Models;
    using BAG.Geolocation.Provider.MaxMind.Internal;
    using Newtonsoft.Json.Linq;

    public class MaxMindApiClient : ILocationService
    {
        private const string DatabaseConfigKey = "BAG.Geolocation.MaxMindDBPath";
