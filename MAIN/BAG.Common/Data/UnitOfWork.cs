...
namespace BAG.Common.Data
{
    public partial class UnitOfWork : IDisposable
    {
        ...
        private GenericRepository<SiteManager> siteManagerRepository;
        public GenericRepository<SiteManager> SiteManagerRepository
        {
            get
            {
                if (this.siteManagerRepository == null)
                    this.siteManagerRepository = new GenericRepository<SiteManager>(context);
                return siteManagerRepository;
            }
        }

        private GenericRepository<WidgetManager> widgetManagerRepository;
        public GenericRepository<WidgetManager> WidgetManagerRepository
        {
            get
            {
                if (this.widgetManagerRepository == null)
                    this.widgetManagerRepository = new GenericRepository<WidgetManager>(context);
                return widgetManagerRepository;
            }
        }
